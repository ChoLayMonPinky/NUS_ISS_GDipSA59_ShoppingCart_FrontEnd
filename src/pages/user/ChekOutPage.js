              ...
              {displayedItems.map((item, index) => (
                <div key={index} className="flex justify-between items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">x{item.quantity}</p> {/* 显示商品数量 */}
                  </div>
                </div>
              ))}
            </div>
          ...
          <form className="mt-8 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input id="state" name="state" type="text" required className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm" placeholder="State" onChange={handleInputChange} />
              </div>
              <div>
